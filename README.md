...
<!-- TODO: replace with a hero GIF (calculus scene — secant → tangent, or function graph with slider) -->
<p align="center">
...
- **Async/await animations** — `await play(fadeIn(c))`. No queues, no schedulers — native promises.
